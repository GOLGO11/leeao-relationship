...
CURATED_IDENTITIES = {
    ...
    "潘毓刚": ["veteran", "military_figure", "friendship"],
    ...
    "郑南榕": ["martyr", "media", "political_dissident", "correspondence", "friendship"],
    ...
    "施启扬": ["classmate_colleague", "legal_official", "politician", "academic", "publishing", "public_debate", "correspondence", "meeting"],
    ...
    "钱穆": ["academic", "correspondence", "public_debate", "meeting"],
    ...
    "吴荣元": ["case_prison", "political_dissident"],
    "陈鸿渐": ["intelligence_police", "case_prison"],
    "蔡俊军": ["case_prison"],
    ...
    "朱光军": ["prison_admin", "prison_guard", "torture_actor"],
    "汪本流": ["prison_admin"],
    "毛世馨": ["prison_admin"],
    "陈晏庭": ["case_prison"],
    "王建福": ["case_prison"],
