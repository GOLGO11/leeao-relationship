...
CURATED_IDENTITIES = {
    ...
    "蒋复璁": ["academic"],
    "陈鼓应": ["academic", "classmate_colleague", "public_debate"],
...
CURATED_IDENTITIES.update({
    ...
    "林洋港": ["legal_official", "politician", "litigation", "meeting", "correspondence"],
    ...
    "庄因": ["classmate_colleague", "friendship", "meeting"],
    ...
    "章炳麟": ["academic", "publishing", "political_dissident", "spiritual"],
